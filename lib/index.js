...
$(document).ready(function() {
  ...
  preloadImages([
    ...
    '/lib/images/red-rocks-gallery/3.png',
    '/lib/images/red-rocks-gallery/4.png',
    '/lib/images/lexington-gallery/1.png',
    '/lib/images/lexington-gallery/2.png',
    '/lib/images/lexington-gallery/3.png',
    '/lib/images/lexington-gallery/4.png',
    '/lib/images/raleigh-gallery/1.png',
    '/lib/images/raleigh-gallery/2.png',
    '/lib/images/raleigh-gallery/3.png',
    '/lib/images/raleigh-gallery/4.png',
    '/lib/images/westminster-gallery/1.png',
    '/lib/images/westminster-gallery/2.png',
    '/lib/images/westminster-gallery/3.png',
    '/lib/images/westminster-gallery/4.png'
  ]);
